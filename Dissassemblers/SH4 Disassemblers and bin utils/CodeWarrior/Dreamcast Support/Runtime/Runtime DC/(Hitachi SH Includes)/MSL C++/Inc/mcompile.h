...
/* For Metrowerks */
	...
	#endif
	#if __option( exceptions )		// as 981016 should be configurable
		#define MSIPL_EXCEPT	
	#endif		
	#if __PPC_EABI__
	...
	#define MSIPL_STATIC_CONST_INIT
		...
		#define MSIPL_WCHART
	#endif
//	#define __MSL_LONGLONG_SUPPORT__  // as 981016 SH has no long long support yet
...
//	#define _CUSTOM_VIRTUAL_FACETS
	...
	#define MSIPL_PARTIAL_SPECIALIZATION	// as 981016 SH C++ compiler uses old FE
	#if !__option(ARM_conform)
		#define MSIPL_MEMBER_TEMPLATE		// as 981016 SH C++ compiler uses old FE
	#endif
...
// as 981016 added define to check for exceptions turned on in the ide